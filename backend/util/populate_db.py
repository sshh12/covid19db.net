...
def add_countries_instance(data):
    ...
    args["alpha2_code"] = data["codes"]["alpha2Code"]
    args["alpha3_code"] = data["codes"]["alpha3Code"]
    ...
    args["region"] = data["region"]["region"]
    args["subregion"] = data["region"]["subregion"]
...
def add_case_stats_instance(data):
    ...
    """
    args = dict()
    args["country_alpha3_code"] = data["country"]["codes"]["alpha3Code"]
    args["date"] = data["date"]
    ...
    args["percent_active"] = data["percentages"]["active"]
    args["percent_fatality"] = data["percentages"]["fatality"]
    args["percent_have_recovered"] = data["percentages"]["haveRecovered"]
    args["percent_infected"] = data["percentages"]["infected"]
    args["smoothed_new_cases"] = data["smoothedNew"]["cases"]
    args["smoothed_new_deaths"] = data["smoothedNew"]["deaths"]
    args["sources"] = data["sources"]
    args["new_tests"] = data["testing"]["newTests"]
    args["new_tests_smoothed"] = data["testing"]["newTestsSmoothed"]
    args["positive_rate"] = data["testing"]["positiveRate"]
    args["total_tests"] = data["testing"]["totalTests"]
