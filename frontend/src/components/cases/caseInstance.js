      ...
      <div>
        ...
        >
          <NewStats
            ...
            data={data.new.cases}
            yesterday={
              Math.round((data.derivativeNew.cases + Number.EPSILON) * 100) /
              100
            }
          ...
          <NewStats
            ...
            yesterday={
              Math.round((data.derivativeNew.active + Number.EPSILON) * 100) /
              100
            }
          ...
          <NewStats
            ...
            yesterday={
              Math.round((data.derivativeNew.deaths + Number.EPSILON) * 100) /
              100
            }
      ...
      <div style={{ marginTop: "50px" }}>
        ...
        >
          <GenStats
            title="Fatality Rate"
            data={
              Math.round((data.percentages.fatality + Number.EPSILON) * 100) /
              100
            }
          ...
          <GenStats
            ...
            data={
              Math.round((data.percentages.infected + Number.EPSILON) * 100) /
              100
            }
          ...
          <GenStats
            title="Active Rate"
            data={
              Math.round((data.percentages.active + Number.EPSILON) * 100) / 100
            }
